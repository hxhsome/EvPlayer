...
const guacOnPause = (): void => {
  // 播放
  console.log('播放')
  playButton.value = '播放'
}

const guacOnPlay = (): void => {
  // 暂停
  console.log('暂停')
  playButton.value = '暂停'
}

const guacOnClick = (): void => {
...
<template>
  ...
  <div class="main">
    ...
    <div v-else-if="playType === 'guacamole'" id="player">
      <div id="displayPlayBack" ref="displayPlayBack">111111</div>
    </div>
